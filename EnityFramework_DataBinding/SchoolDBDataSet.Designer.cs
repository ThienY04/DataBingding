...
namespace EnityFramework_DataBinding {
    ...
    public partial class SchoolDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(int StudentId, string FullName, int Age, string Major) {
...
namespace EnityFramework_DataBinding.SchoolDBDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentId], [FullName], [Age], [Major]) VALUES (@S" +
                "tudentId, @FullName, @Age, @Major);\r\nSELECT StudentId, FullName, Age, Major FROM" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [StudentId] = @StudentId, [FullName] = @FullName, [Age] = @Age, [Major] = @Major WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)));
SELECT StudentId, FullName, Age, Major FROM Students WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EnityFramework_DataBinding.Properties.Settings.Default.SchoolDBConnectionString;
        }
        ...
        public virtual int Insert(int StudentId, string FullName, global::System.Nullable<int> Age, string Major) {
        ...
        public virtual int Update(int StudentId, string FullName, global::System.Nullable<int> Age, string Major, int Original_StudentId, string Original_FullName, global::System.Nullable<int> Original_Age, string Original_Major) {
